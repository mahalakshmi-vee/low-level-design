...
3. The system should interact with the bank's backend system to validate user accounts and perform transactions.
...
6. The ATM should have user-friendly interface for users to interact with.
